...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return CommonProto.internal_static_common_EntityPath_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return CommonProto.internal_static_common_EntityPath_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            EntityPath.class, Builder.class);
  }
  ...
  public static EntityPath parseFrom(
  ...
  public static EntityPath parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static EntityPath parseFrom(
  ...
  public static EntityPath parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static EntityPath parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static EntityPath parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(EntityPath prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public EntityPath getDefaultInstanceForType() {
      return EntityPath.getDefaultInstance();
    }

    @Override
    public EntityPath build() {
      EntityPath result = buildPartial();
    ...
    @Override
    public EntityPath buildPartial() {
      EntityPath result = new EntityPath(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof EntityPath) {
        return mergeFrom((EntityPath)other);
      } else {
    ...
    public Builder mergeFrom(EntityPath other) {
      if (other == EntityPath.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      EntityPath parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (EntityPath) e.getUnfinishedMessage();
  ...
  private static final EntityPath DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new EntityPath();
  }

  public static EntityPath getDefaultInstance() {
