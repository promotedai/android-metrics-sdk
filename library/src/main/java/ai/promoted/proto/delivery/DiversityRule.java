...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Blender.internal_static_delivery_DiversityRule_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Blender.internal_static_delivery_DiversityRule_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DiversityRule.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DiversityRule)) {
      return super.equals(obj);
    }
    DiversityRule other = (DiversityRule) obj;

    if (hasMulti() != other.hasMulti()) return false;
    if (hasMulti()) {
      if (Double.doubleToLongBits(getMulti())
  ...
  public int hashCode() {
    ...
    if (hasMulti()) {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          Double.doubleToLongBits(getMulti()));
    }
  ...
  public static DiversityRule parseFrom(
  ...
  public static DiversityRule parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DiversityRule parseFrom(
  ...
  public static DiversityRule parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DiversityRule parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DiversityRule parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DiversityRule prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DiversityRule getDefaultInstanceForType() {
      return DiversityRule.getDefaultInstance();
    }

    @Override
    public DiversityRule build() {
      DiversityRule result = buildPartial();
    ...
    @Override
    public DiversityRule buildPartial() {
      DiversityRule result = new DiversityRule(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DiversityRule) {
        return mergeFrom((DiversityRule)other);
      } else {
    ...
    public Builder mergeFrom(DiversityRule other) {
      if (other == DiversityRule.getDefaultInstance()) return this;
      if (other.hasMulti()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DiversityRule parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DiversityRule) e.getUnfinishedMessage();
  ...
  private static final DiversityRule DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DiversityRule();
  }

  public static DiversityRule getDefaultInstance() {
